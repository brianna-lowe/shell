...
Copy ./data/raw/*server*.log ./data/processed/server_logs
# 6. Repeat the above step for user logs and event logs
Copy ./data/raw/*user*.log ./data/processed/server_logs
Copy ./data/raw/*event*.log ./data/processed/server_logs
